    ...
    <section id='projects' className="w-full min-h-screen grid grid-cols-1 place-items-center gap-10 px-5 lg:px-20 py-10">
      ...
      <div className="w-full flex flex-wrap lg:grid-cols-3 gap-7 lg:w-fit lg:gap-10 justify-center">
        {projetcsData.map((category, index) => {
          ...
          return (
            <div key={index} className="flex flex-col items-start justify-center gap-4 h-auto pb-5 md:h-120 w-full lg:w-95 bg-black/30 backdrop-blur-xl rounded-xl border border-white/25 hover:border-[#00f7ff]  transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_35px_rgba(0,217,255,0.25)] overflow-hidden">
